...
def test_get_words(input_text):
    words = get_words(input_text)
    print(words)
    assert len(words) == 6


def test_get_characters_with_space(input_text):
    cars = get_characters_with_spaces(input_text)
    print(cars)
    assert len(cars) == 35


def test_get_characters_without_space(input_text):
    cars = get_characters_without_spaces(input_text)
    print(cars)
    assert len(cars) == 20
